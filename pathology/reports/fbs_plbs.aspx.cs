...
public partial class pathology_reports_fbs_plbs : System.Web.UI.Page
{
    DataClassesDataContext rt = new DataClassesDataContext();
    palm_pathology_fbs_plb ppb = new palm_pathology_fbs_plb();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["print"] == null)
       {
        ...
        else
        {
            ...
            palm_pathology_fbs_plb ppm = new palm_pathology_fbs_plb();
            String dr1 = Session["slave_id"].ToString();
            ppm = rt.palm_pathology_fbs_plbs.Single(palm_pathology_fbs_plb => palm_pathology_fbs_plb.slave_id == Session["slave_id"].ToString());
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        rt.palm_pathology_fbs_plbs.InsertOnSubmit(ppb);
        rt.SubmitChanges();
        ...
        rt.SubmitChanges();
        // fill print
        ppb = rt.palm_pathology_fbs_plbs.Single(palm_pathology_fbs_plb => palm_pathology_fbs_plb.slave_id == Session["slave_id"].ToString());
