...
public partial class pathology_reports_blood_group : System.Web.UI.Page
{
    DataClassesDataContext rt = new DataClassesDataContext();
    palm_pathology_bg ppb = new palm_pathology_bg();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                pde = rt.palm_doctor_employees.Single(palm_doctor_employee => palm_doctor_employee.emp_code == Session["ref_doctor"].ToString());
                Label0.Text = pde.doctor_name;
            }
            catch (InvalidOperationException rtt)
            {
                palm_pateints_profile ppp = new palm_pateints_profile();
                ppp = rt.palm_pateints_profiles.Single(palm_pateints_profile => palm_pateints_profile.pateint_code == Session["pateint_code"].ToString());
                Label0.Text = ppp.ref_doc;
            ...
            palm_pathology_bg ppm = new palm_pathology_bg();
            ppm = rt.palm_pathology_bgs.Single(palm_pathology_bg => palm_pathology_bg.slave_id == Session["slave_id"].ToString());
            Label238.Text = ppm.abo_group;
            Label239.Text = ppm.rh_d;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ppb.abo_group =TextBox3.Text;
        ppb.rh_d = TextBox1.Text;
        

        rt.palm_pathology_bgs.InsertOnSubmit(ppb);
        rt.SubmitChanges();
        ...
        rt.SubmitChanges();
        // fill print
        ppb = rt.palm_pathology_bgs.Single(palm_pathology_bg => palm_pathology_bg.slave_id == Session["slave_id"].ToString());
        Label2.Text = Session["pateint_name"].ToString();
        Label0.Text = Session["ref_doctor"].ToString();
        Label00.Text = d.Text;
        Label238.Text = Convert.ToString(ppb.abo_group);
        Label239.Text = Convert.ToString(ppb.rh_d);
        MultiView1.ActiveViewIndex = 1;
    }
