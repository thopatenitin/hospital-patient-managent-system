...
public partial class pathology_reports_CREATNINE : System.Web.UI.Page
{
    DataClassesDataContext rt = new DataClassesDataContext();
    palm_pathology_creatnine ppb = new palm_pathology_creatnine();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            palm_pathology_creatnine ppm = new palm_pathology_creatnine();
            ppm = rt.palm_pathology_creatnines.Single(palm_pathology_creatnine => palm_pathology_creatnine.slave_id == Session["slave_id"].ToString());
            labe6.Text = Convert.ToString(ppm.cretnine);
            ...
            Label225.Text = Convert.ToString(Convert.ToString(pps.date));
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ppb.cretnine = Convert.ToDecimal(TextBox1.Text);
       

        rt.palm_pathology_creatnines.InsertOnSubmit(ppb);
        rt.SubmitChanges();
        ...
        rt.SubmitChanges();
        // fill print
        ppb = rt.palm_pathology_creatnines.Single(palm_pathology_creatnine => palm_pathology_creatnine.slave_id == Session["slave_id"].ToString());

        Label223.Text = Session["pateint_name"].ToString();
        Label1.Text = Session["ref_doctor"].ToString();
        Label225.Text = d.Text;
        labe6.Text = Convert.ToString(ppb.cretnine);
