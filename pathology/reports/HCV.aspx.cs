...
public partial class pathology_reports_HCV : System.Web.UI.Page
{
    DataClassesDataContext rt = new DataClassesDataContext();
    palm_pathology_hcv ppb = new palm_pathology_hcv();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["print"] == null)
        {
            ...
            label00.Text = Session["pateint_name"].ToString();
        ...
        else
        {
            Session["print"] = null;
            palm_doctor_employee pde = new palm_doctor_employee();
            //alm_doctor_employee pde = new palm_doctor_employee();
            // palm_doctor_employee pde = new palm_doctor_employee();
            // label0.Text = Session["pateint_name"].ToString();
            try
            {
            ...
            palm_pathology_hcv ppm = new palm_pathology_hcv();
            ppm = rt.palm_pathology_hcvs.Single(palm_pathology_hcv => palm_pathology_hcv.slave_id == Session["slave_id"].ToString());
            labe6.Text = Convert.ToString(ppm.hcv);
