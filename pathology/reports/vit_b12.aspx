<%@ Page Title="" Language="C#" MasterPageFile="~/pathology/pathology.master" AutoEventWireup="true" CodeFile="vit_b12.aspx.cs" Inherits="pathology_reports_vit_b12" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <table class="auto-style6">
                                ...
                                <tr>
                                    <td class="auto-style18">
                                        <asp:Label ID="Label261" runat="server" Text="TEST ASKED"></asp:Label>
                                    </td>
                                    <td class="auto-style25">:
                                        <asp:Label ID="Label9" runat="server" Text="Vitamin B12"></asp:Label>
                                    </td>
                                    <td class="auto-style26">&nbsp;</td>
                                    <td class="auto-style23">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td colspan="4" style="text-align:center;">
                                        <asp:Label ID="Label199" runat="server" Text="VITAMIN B 12" Font-Bold="True"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table class="auto-style7">
                                ...
                                <tr>
                                    <td class="auto-style9">
                                        <asp:Label ID="Label241" runat="server" Text="Vitamin B12"></asp:Label>
                                    </td>
                                    <td class="auto-style12">
                                        <asp:Label ID="Label245" runat="server" Text="C.L.I.A"></asp:Label>
                                    </td>
                                    <td class="auto-style11">
                                        <asp:TextBox ID="TextBox1" runat="server" ></asp:TextBox>
                                    </td>
                                    <td class="auto-style8">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="TextBox1" ErrorMessage="Enter Reading" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style12">
                                        <asp:Label ID="Label243" runat="server" Text="211 - 911 pg/ml"></asp:Label>
                                    </td>
                                    <td class="auto-style11">&nbsp;</td>
                                    <td class="auto-style8">&nbsp;</td>
                                    <td>&nbsp;</td>
                        ...
                        <td>
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>:
                                        <asp:Label ID="Label250" runat="server" Text="Vitamin B12"></asp:Label>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td colspan="4" style="text-align:center;">
                                        <asp:Label ID="Label249" runat="server" Font-Bold="True" Text="VITAMIN B 12"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td class="auto-style22">
                                        <asp:Label ID="Label247" runat="server" Text="METHOD" Font-Bold="True"></asp:Label>
                                    </td>
                                    <td class="auto-style11">
                                ...
                                <tr>
                                    <td class="auto-style21">
                                        <asp:Label ID="Label252" runat="server" Text="Vitamin B12"></asp:Label>
                                    </td>
                                    <td class="auto-style22">
                                        <asp:Label ID="Label262" runat="server" Text="C.L.I.A"></asp:Label>
                                    </td>
                                    <td class="auto-style11">
                                ...
                                <tr>
                                    <td class="auto-style21">
                                        <asp:Label ID="Label242" runat="server" Text="Referance Range"></asp:Label>
                                    </td>
                                    <td class="auto-style22">:<asp:Label ID="Label256" runat="server" Text="211 - 911 pg/ml"></asp:Label>
                                    </td>
                                    <td class="auto-style11">&nbsp;</td>
                                    <td class="auto-style8">&nbsp;</td>
                                    <td>&nbsp;</td>
