...
public partial class pathology_reports_amylase : System.Web.UI.Page
{
    DataClassesDataContext rt = new DataClassesDataContext();
    palm_pathology_amylase ppb = new palm_pathology_amylase();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //Label225.Text = Session["ref_doctor"].ToString();
            palm_pathology_amylase ppm = new palm_pathology_amylase();
            ppm = rt.palm_pathology_amylases.Single(palm_pathology_amylase => palm_pathology_amylase.slave_id == Session["slave_id"].ToString());
            labe6.Text = Convert.ToString(ppm.amylase);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ppb.amylase = TextBox1.Text;
        
        rt.palm_pathology_amylases.InsertOnSubmit(ppb);
        rt.SubmitChanges();
        ...
        pos.date = TextBox2.Text;
        pos.is_done = "Completed";
        rt.SubmitChanges();
        // fill print
        ppb = rt.palm_pathology_amylases.Single(palm_pathology_amylase => palm_pathology_amylase.slave_id == Session["slave_id"].ToString());
        Label223.Text = Session["pateint_name"].ToString();
        Label225.Text = Session["ref_doctor"].ToString();
        Label1.Text = TextBox2.Text; 
        labe6.Text = Convert.ToString(ppb.amylase);
