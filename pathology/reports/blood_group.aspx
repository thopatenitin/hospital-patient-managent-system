<%@ Page Title="" Language="C#" MasterPageFile="~/pathology/pathology.master" AutoEventWireup="true" CodeFile="blood_group.aspx.cs" Inherits="pathology_reports_blood_group" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content_td" Runat="Server">
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                            ...
                            <table class="auto-style6">
                                ...
                                <tr>
                                    <td colspan="4" style="text-align:center;">
                                        <asp:Label ID="Label199" runat="server" Text="HAEMATOLOGY" Font-Bold="True"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table style=" width: 100%;"">
                                ...
                                <tr>
                                    <td class="auto-style9">
                                        <asp:Label ID="Label17" runat="server" Text="Blood Group" Font-Bold="True" Font-Underline="True"></asp:Label>
                                    </td>
                                    <td class="auto-style12">&nbsp;</td>
                                ...
                                <tr>
                                    <td class="auto-style9">
                                        <asp:Label ID="Label220" runat="server" Text="ABO Group"></asp:Label>
                                    </td>
                                    <td class="auto-style12">:</td>
                                    <td class="auto-style11">
                                        <asp:TextBox ID="TextBox3" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
                                        <ajaxToolkit:FilteredTextBoxExtender ID="TextBox3_FilteredTextBoxExtender" runat="server" FilterType="UppercaseLetters" TargetControlID="TextBox3" />
                                    </td>
                                    <td class="auto-style8">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="TextBox3" ErrorMessage="Mandatory" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td class="auto-style9">
                                        <asp:Label ID="Label221" runat="server" Text="RH(D)"></asp:Label>
                                    </td>
                                    <td class="auto-style12">:</td>
                                    <td class="auto-style11">
                                    ...
                                    <td class="auto-style8">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="TextBox1" ErrorMessage="Mandatory" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
        ...
        <asp:View ID="View2" runat="server">
            <asp:Panel ID="Panel8" runat="server" BackColor="White" Height="666px" Width="1091px">
                <table style="width:100%;">
                    <tr>
                        <td>&nbsp;</td>
                        <td>
                            <table style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style21">:
                                        <asp:Label ID="Label229" runat="server" Text="Blood Group"></asp:Label>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td colspan="4" style="text-align:center;">
                                        &nbsp;&nbsp;&nbsp;
                                        <asp:Label ID="Label230" runat="server" Font-Bold="True" Text="HAEMATOLOGY"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table style=" width: 100%;">
                                ...
                                <tr>
                                    <td class="auto-style9">
                                        <asp:Label ID="Label233" runat="server" Font-Bold="True" Font-Underline="True" Text="Blood Group"></asp:Label>
                                    </td>
                                    <td class="auto-style19">&nbsp;</td>
                                ...
                                <tr>
                                    <td class="auto-style9">
                                        <asp:Label ID="Label234" runat="server" Text="ABO Group"></asp:Label>
                                    </td>
                                    <td class="auto-style19">:</td>
                                    <td class="auto-style20">
                                        <asp:Label ID="Label238" runat="server"></asp:Label>
                                    </td>
                                    <td class="auto-style8">&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td class="auto-style9">
                                        <asp:Label ID="Label235" runat="server" Text="RH(D)"></asp:Label>
                                    </td>
                                    <td class="auto-style19">:</td>
                                    <td class="auto-style20">
