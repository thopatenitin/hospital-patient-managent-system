...
public partial class pathology_reports_vit_b12 : System.Web.UI.Page
{
    DataClassesDataContext rt = new DataClassesDataContext();
    palm_pathology_vitb12 pph = new palm_pathology_vitb12();
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
          ...
          //  palm_doctor_employee pde = new palm_doctor_employee();
            ...
            palm_pathology_vitb12 ppm = new palm_pathology_vitb12();
            ppm = rt.palm_pathology_vitb12s.Single(palm_pathology_vitb12 => palm_pathology_vitb12.slave_id == Session["slave_id"].ToString());
            Label253.Text = ppm.vitamin_b_12.ToString();
