...
public partial class pathology_ra_test : System.Web.UI.Page
{
    DataClassesDataContext rt = new DataClassesDataContext();
    palm_pathology_ra_test ppb = new palm_pathology_ra_test();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //      palm_doctor_employee pde = new palm_doctor_employee();
            ...
            palm_pathology_ra_test ppm = new palm_pathology_ra_test();
            ppm = rt.palm_pathology_ra_tests.Single(palm_pathology_ra_test => palm_pathology_ra_test.slave_id == Session["slave_id"].ToString());
            labe6.Text = Convert.ToString(ppm.ra_test);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        ppb.ra_test= Convert.ToDecimal(TextBox1.Text);
     

        rt.palm_pathology_ra_tests.InsertOnSubmit(ppb);
        rt.SubmitChanges();
        ...
        rt.SubmitChanges();
        // fill print
        ppb = rt.palm_pathology_ra_tests.Single(palm_pathology_ra_test => palm_pathology_ra_test.slave_id == Session["slave_id"].ToString());
        Label223.Text = Session["pateint_name"].ToString();
        Label1.Text = Session["ref_doctor"].ToString();
        Label225.Text = d.Text;
        labe6.Text = Convert.ToString(ppb.ra_test);
