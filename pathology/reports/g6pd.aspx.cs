...
/// <summary>
/// Summary description for g6pd
/// </summary>
public partial class pathology_reports_g6pd:System.Web.UI.Page
{
    DataClassesDataContext rt = new DataClassesDataContext();
    palm_pathology_g6pd ppl = new palm_pathology_g6pd();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Label225.Text = Convert.ToDateTime(pps.date).ToString("dd/MM/yyyy");
