<%@ Page Title="" Language="C#" MasterPageFile="~/pathology/pathology.master" AutoEventWireup="true" CodeFile="pathology_home.aspx.cs" Inherits="pathology_pathology_home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content_td" Runat="Server">
    ...
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="1044px">
                    ...
                    <tr>
                        <td>
                            <asp:Panel ID="Panel7" runat="server">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Grid" DataKeyNames="slave_id" DataSourceID="SqlDataSource1" GridLines="Horizontal" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="974px">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ref_by" HeaderText="Referance Doctor" SortExpression="ref_by" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:palmConnectionString %>" SelectCommand="sp_pathology_info" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                            </asp:Panel>
                        </td>
                    </tr>
                            ...
                            <asp:Panel ID="Panel8" runat="server">
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CssClass="Grid" DataKeyNames="slave_id" DataSourceID="SqlDataSource2" GridLines="Horizontal" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" Width="1004px">
                                    <Columns>
                                        <asp:BoundField DataField="slave_id" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="slave_id" />
                                        <asp:BoundField DataField="patient_code" HeaderText="Pateint Code" SortExpression="patient_code" />
                                        <asp:BoundField DataField="opd_code" HeaderText="OPD  Code" SortExpression="opd_code" />
                                        <asp:BoundField DataField="inserted_by" HeaderText="Ref Doctor" SortExpression="inserted_by" />
                                        <asp:BoundField DataField="pateient_first_name" HeaderText="First Name" SortExpression="pateient_first_name" />
                                        <asp:BoundField DataField="pateient_last_name" HeaderText="Last Name" SortExpression="pateient_last_name" />
                                        <asp:BoundField DataField="test_name" HeaderText="test_name" SortExpression="test_name" />
                                        <asp:BoundField DataField="is_done" HeaderText="Status" />
                                        <asp:CommandField ShowSelectButton="True" />
                                    </Columns>
                                </asp:GridView>
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:palmConnectionString %>" SelectCommand="sp_pathology_info_completed" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                            </asp:Panel>
                        </td>
