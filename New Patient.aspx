<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="New Patient.aspx.cs" Inherits="New_Patient" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content_td" Runat="Server">
                  ...
                  <table class="auto-style7">
                      ...
                      <tr>
                          ...
                          <td class="auto-style22">
                              <asp:RadioButtonList ID="redirect" runat="server" Height="25px" RepeatDirection="Horizontal" Width="220px" AutoPostBack="True" OnSelectedIndexChanged="redirect_SelectedIndexChanged">
                                  <asp:ListItem>OPD</asp:ListItem>
                                  <asp:ListItem>IPD</asp:ListItem>
                                  <asp:ListItem>Pathology</asp:ListItem>
                              </asp:RadioButtonList>
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ControlToValidate="redirect" ErrorMessage="Select Department" ForeColor="Red"></asp:RequiredFieldValidator>
                              <br />
                          </td>
                      </tr>
                      <tr>
      ...
      <asp:Panel ID="Panel10" runat="server" BackColor="White">
          <fieldset style="border:2px solid black;" class="auto-style25">
              <legend>
                  <asp:Label runat="server" Text="Personal Information" Font-Bold="True" Font-Size="16pt" ID="Label67"></asp:Label>
              </legend>
              <table class="auto-style7">
                  <tr>
                      <td class="auto-style10">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;</td>
                      <td>
                          <asp:Label runat="server" Text="Required Feilds*" ID="Label68"></asp:Label>
                          <br />
                      </td>
                      <td class="auto-style22">&nbsp;</td>
                  </tr>
                  <tr>
                      <td class="auto-style10">&nbsp;</td>
                      <td style="vertical-align:top;">
                          <asp:Label runat="server" Text="Department" ID="Label69"></asp:Label>
                      </td>
                      <td class="auto-style22">
                          <asp:RadioButtonList ID="redirect0" runat="server" Height="25px" RepeatDirection="Horizontal" Width="220px" AutoPostBack="True" OnSelectedIndexChanged="redirect_SelectedIndexChanged">
                              <asp:ListItem>OPD</asp:ListItem>
                              <asp:ListItem>IPD</asp:ListItem>
                              <asp:ListItem>Pathology</asp:ListItem>
                          </asp:RadioButtonList>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" ControlToValidate="redirect0" ErrorMessage="Select Department" ForeColor="Red"></asp:RequiredFieldValidator>
                          <br />
                      </td>
                  </tr>
                  <tr>
                      <td class="auto-style10">&nbsp;</td>
                      <td>
                          <asp:Label ID="Label70" runat="server" Text="Title"></asp:Label>
                          &nbsp;<br /> </td>
                      <td class="auto-style22">
                  ...
                  <tr>
                      <td class="auto-style10">&nbsp;</td>
                      <td>
                          <asp:Label runat="server" Text="Name : *" ID="Label71"></asp:Label>
                          <br />
                          <br />
                      </td>
                      <td class="auto-style22">
                          <table class="auto-style19">
                              <tr>
                                  <td>
                                      <asp:TextBox ID="TextBox49" runat="server" OnTextChanged="TextBox49_TextChanged" ValidationGroup="secondary"></asp:TextBox>
                                      <ajaxToolkit:TextBoxWatermarkExtender ID="TextBox49_TextBoxWatermarkExtender" runat="server" BehaviorID="TextBox49_TextBoxWatermarkExtender" TargetControlID="TextBox49" WatermarkText="First Name" />
                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="TextBox49" ErrorMessage="Fill First Name"></asp:RequiredFieldValidator>
                                  </td>
                                  <td>
                                      <asp:TextBox ID="name" runat="server" OnTextChanged="TextBox49_TextChanged" ValidationGroup="secondary"></asp:TextBox>
                                      <ajaxToolkit:TextBoxWatermarkExtender ID="name_TextBoxWatermarkExtender" runat="server" BehaviorID="name_TextBoxWatermarkExtender" TargetControlID="name" WatermarkText="Middle Name" />
                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server" ControlToValidate="name" ErrorMessage="Fill Middle Name"></asp:RequiredFieldValidator>
                                  </td>
                                  <td>
                                      <asp:TextBox ID="TextBox58" runat="server" OnTextChanged="TextBox49_TextChanged" ValidationGroup="secondary"></asp:TextBox>
                                      <ajaxToolkit:TextBoxWatermarkExtender ID="TextBox58_TextBoxWatermarkExtender" runat="server" BehaviorID="TextBox58_TextBoxWatermarkExtender" TargetControlID="TextBox58" WatermarkText="Last Name" />
                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator28" runat="server" ControlToValidate="TextBox58" ErrorMessage="Fill Last Name"></asp:RequiredFieldValidator>
                                  </td>
                              </tr>
                          </table>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                  ...
                  <tr>
                      <td class="auto-style10">&nbsp;</td>
                      <td>
                          <asp:Label runat="server" Text="Age*" ID="Label76"></asp:Label>
                          <br />
                          <br />
                      </td>
                      <td class="auto-style22">
                          <asp:TextBox runat="server" ID="TextBox52" OnTextChanged="TextBox52_TextChanged" ValidationGroup="secondary"></asp:TextBox>
                          <ajaxToolkit:FilteredTextBoxExtender runat="server" FilterType="Numbers" BehaviorID="TextBox31_FilteredTextBoxExtender" TargetControlID="TextBox52" ID="TextBox52_FilteredTextBoxExtender">
                          </ajaxToolkit:FilteredTextBoxExtender>
                          <asp:RequiredFieldValidator runat="server" ControlToValidate="TextBox52" ErrorMessage="Fill Age" ID="RequiredFieldValidator23"></asp:RequiredFieldValidator>
                      </td>
                  </tr>
                  <tr>
                      <td class="auto-style10">&nbsp;</td>
                      <td>
                          <asp:Label ID="Label78" runat="server" Text="Ref Doctor : *"></asp:Label>
                      </td>
                      <td class="auto-style22">
                          <asp:TextBox ID="refdoct" runat="server" OnTextChanged="TextBox52_TextChanged" ValidationGroup="secondary"></asp:TextBox>
                          <ajaxToolkit:FilteredTextBoxExtender ID="refdoct_FilteredTextBoxExtender" runat="server" BehaviorID="TextBox31_FilteredTextBoxExtender" FilterType="Numbers" TargetControlID="refdoct" />
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator29" runat="server" ControlToValidate="refdoct" ErrorMessage="Enter Ref Doctor"></asp:RequiredFieldValidator>
                      </td>
                  </tr>
                  <tr>
                      <td class="auto-style10">&nbsp;</td>
                      <td>
                          <asp:Label runat="server" Text="Gender*" ID="Label77"></asp:Label>
                          <br />
                          <br />
                      </td>
                      <td class="auto-style22">
                          <asp:RadioButtonList runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" ID="RadioButtonList3" ValidationGroup="secondary">
                              <asp:ListItem>Male</asp:ListItem>
                              <asp:ListItem>Female</asp:ListItem>
                          </asp:RadioButtonList>
                          <br />
                          <asp:RequiredFieldValidator runat="server" ControlToValidate="RadioButtonList3" ErrorMessage="Select Gender" ID="RequiredFieldValidator24"></asp:RequiredFieldValidator>
                      </td>
                  </tr>
                  <tr>
                      <td class="auto-style10">&nbsp;</td>
                      ...
                      <td class="auto-style22">
                          <br />
                          <asp:Button ID="save" runat="server" BorderStyle="None" Height="29px" OnClick="save_Click" Text="Save" Width="72px" ValidationGroup="secondary" />
                          <ajaxToolkit:DropShadowExtender ID="save_DropShadowExtender" runat="server" BehaviorID="Button6_DropShadowExtender" TargetControlID="save" />
                      </td>
                  </tr>
              </table>
          </fieldset></asp:Panel>
