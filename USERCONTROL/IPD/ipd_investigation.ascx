<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ipd_investigation.ascx.cs" Inherits="USERCONTROL_IPD_ipd_investigation" %>
...
&nbsp;<asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table class="auto-style13">
                                        <tr>
                                            <td style="vertical-align:top;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="path_id,slave_id" DataSourceID="SqlDataSource1" Height="151px" Width="868px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                                <Columns>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:palmConnectionString %>" SelectCommand="sp_get_investigationdetail_byinserted_by" SelectCommandType="StoredProcedure">
                                                    <SelectParameters>
                                                        <asp:Parameter Name="emp_code" Type="String" />
                                                        <asp:Parameter Name="opd_code" Type="String" />
                                                    </SelectParameters>
                                                </asp:SqlDataSource>
                                            </td>
